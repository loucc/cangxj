 ...
 * 连接本地 PostgreSQL，读取表结构元数据，生成完整 CRUD 代码到 cxj-modules 模块。
 */
public class CodeGenerator {
    ...
    // ====== 项目配置 ======
    private static final String BASE_PACKAGE = "com.cxj.modules.system";
    ...
    public static void main(String[] args) {
        ...
        String javaOutputDir = projectPath + "/cxj-modules/src/main/java";
    ...
    private static List<CustomFile> buildCustomFiles() {
        ...
        return List.of(
                ...
                new CustomFile.Builder()
                        ...
                        .filePath(System.getProperty("user.dir") + "/cxj-admin/src/main/resources/mapper")
                        .build()
        );
    }
}
